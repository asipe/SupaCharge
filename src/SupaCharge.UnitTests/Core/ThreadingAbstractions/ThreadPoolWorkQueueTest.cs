...
namespace SupaCharge.UnitTests.Core.ThreadingAbstractions {
  [TestFixture]
  public class ThreadPoolWorkQueueTest : BaseTestCase {
    [Test]
    ...
    private void CheckDifferentThread() {
      Assert.That(Thread.CurrentThread.ManagedThreadId, Is.Not.EqualTo(mThreadID));
    }

    private ThreadPoolWorkQueue mQueue;
